...
'''
Summary : For this file we called the US currency model and got output as class_name.
'''
...
fig = plt.figure()
model = "./model/model_usa_adam.h5"

with open("custom.css") as f:
    st.markdown(f"<style>{f.read()}</style>", unsafe_allow_html=True)

st.title('US Currency Classifier')
...
def usa_currency_classify(img, model):
    ...
    classes = ["100dollars", "10dollars", "1dollar", "20dollars", "50dollars", "5dollars"]
    print(classes)
